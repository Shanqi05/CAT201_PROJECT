...
import { Search, UserX, Shield, User, Mail, Users, Filter, ShieldPlus, ShieldOff } from 'lucide-react';
...
const ManageUsers = () => {
    ...
    const handleRoleChange = async (user, newRole) => {
        ...
        const confirmMsg = newRole === 'ADMIN'
            ...
            : `Are you sure you want to demote @${user.username} to Customer?`;
        ...
        if(window.confirm(confirmMsg)) {
            try {
                ...
                const response = await fetch('http://localhost:8080/CAT201_project/updateUserRole', {
                    method: 'POST',
                ...
                if (result.success) {
                    ...
                    alert(`Success! User has been ${action.toLowerCase()}d.`);

                    // [FIX] Proper Logout if Self-Demotion
                    if (currentUser && currentUser.userId === user.userId && newRole === 'USER') {
                        alert("You have demoted your own account. You no longer have Admin privileges and will be logged out.");
                                        ...
                                        <td className="p-5">
                                            <div className="flex items-center gap-3">
                                                <div className={`w-10 h-10 rounded-full flex items-center justify-center text-white font-bold shadow-sm ${
                                                    isAdmin ? 'bg-gradient-to-br from-purple-500 to-indigo-600' : 'bg-gradient-to-br from-cyan-400 to-blue-500'
                                                }`}>
